...
def run_test_factorial():
    ...
    # Test 4:
    answer_from_oracle = math.factorial(32)
    answer_from_my_code = factorial(32)
    print('Test 2 expected (from oracle):', answer_from_oracle)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 1
    answer = count_cosines_from(1, 3, 0.5)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 2
    answer = count_cosines_from(7, 12, 0.34)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 2
    answer = count_cosines_from(100, 105, 0.8)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 3
    answer = count_cosines_from(3, 9, 0.1)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 1
    answer = count_cosines_from(1, 4, 0.2)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
